  ...
  return (
    <div className="container-page flex flex-col gap-10">
      <section className="rounded-[26px] bg-white px-8 py-10 shadow-soft">
        ...
        <p className="mt-3 max-w-3xl text-lg text-slate-700">{text.intro1}</p>
        <p className="mt-3 text-slate-700">{text.intro2}</p>
      </section>
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-ink">
            ...
            <input
              ...
              {...register('role')}
            />
            {errors.role && <span className={errorColor}>{errors.role.message}</span>}
          </label>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <label className="flex flex-col gap-2 text-sm font-medium text-ink">
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-ink">
            ...
            {errors.size && <span className={errorColor}>{errors.size.message}</span>}
          </label>
        </div>
        <label className="flex flex-col gap-2 text-sm font-medium text-ink">
          {text.form.industry}
        ...
        <div className="rounded-2xl border border-sand bg-white px-5 py-5 shadow-sm">
              ...
              return (
                <label
                  ...
                  className={classNames(
                    ...
                    !checked && maxSituationReached ? 'opacity-60' : 'opacity-100',
                  )}
                >
                  <input
                    type="checkbox"
          ...
          {errors.situation && <p className={errorColor}>{errors.situation.message}</p>}
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <label className="flex flex-col gap-2 text-sm font-medium text-ink">
            ...
            >
              <option value="">{language === 'en' ? 'Select an option' : 'Pilih opsi'}</option>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-sand bg-white px-5 py-5 shadow-sm">
            <p className="text-sm font-semibold text-ink">{text.form.readinessTitle}</p>
            ...
            {errors.readiness && <p className={errorColor}>{errors.readiness.message}</p>}
          </div>
          <div className="rounded-2xl border border-sand bg-white px-5 py-5 shadow-sm">
            <p className="text-sm font-semibold text-ink">{text.form.timelineTitle}</p>
            <div className="mt-3 space-y-2">
            ...
            {errors.timeline && <p className={errorColor}>{errors.timeline.message}</p>}
          </div>
        </div>
        ...
        {submitted && (
          <div className="rounded-2xl border border-ink bg-mist px-5 py-4 text-sm text-ink">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                {submitted.name} — {submitted.role} at {submitted.organization} ({submitted.size})
              </li>
