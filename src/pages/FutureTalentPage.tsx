    ...
    <div className="container-page flex flex-col gap-12">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="glass-panel p-8">
          <h2 className="text-xl font-semibold text-ink">{page.problemTitle}</h2>
          <p className="mt-3 text-slate-700">{page.problemIntro}</p>
        ...
        <div className="rounded-2xl border border-sand bg-white p-8 shadow-soft">
          <h2 className="text-xl font-semibold text-ink">{page.futureTitle}</h2>
          <p className="mt-3 text-slate-700">{page.futureIntro}</p>
          <ul className="mt-4 space-y-2 text-slate-700">
      ...
      <section className="grid gap-6 md:grid-cols-[1.2fr_0.8fr] md:items-start">
        <div className="glass-panel p-8">
          <h3 className="text-xl font-semibold text-ink">{page.approachTitle}</h3>
          <p className="mt-3 text-slate-700">{page.approachBody}</p>
        </div>
        <div className="rounded-2xl border border-sand bg-white p-8 shadow-soft">
      ...
      <section className="grid gap-6 rounded-[24px] bg-white px-8 py-8 shadow-soft md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-slate-700">{page.whenBody}</p>
        </div>
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">
            {page.whoTitle}
